...
<td valign="top" style="font-size:x-small; text-align:left; color:#4ca778;"><strong>名古屋校『週３回ｸﾗｽ』開設のお知らせ</strong></td>
</tr>
</table>
</div>
...
<td valign="top" style="font-size:x-small; text-align:left;"><p>
	名古屋校『週３回ｸﾗｽ』 ２０１３年４月開設</p>
<p>
	２０１３年４月より､名古屋校に『週３回ｸﾗｽ』を新たに開設いたしました｡<br />
	『週３回ｸﾗｽ』では､｢演技｣｢ﾎﾞｰｶﾙ｣｢ﾀﾞﾝｽ｣のﾚｯｽﾝを週にそれぞれ３時間ずつ､合計９時間行い､時代のﾆｰｽﾞに応える声優（役者）の育成を目指してまいります｡</p>
<p>
	<a href="http://www.nichinare.com/m/course/threedays.php">【週３回ｸﾗｽのご紹介】</a></p>
</td>
</tr>
</table>
</div>
