...
<td valign="top" style="font-size:x-small; text-align:left; color:#4ca778;"><strong>横浜校（神奈川）開校のお知らせ</strong></td>
</tr>
</table>
</div>
...
<td valign="top" style="font-size:x-small; text-align:left;"><p>
	２０１２年４月　横浜校　開校！<br />
	大宮校･立川校に続き､より通いやすい環境を提供してまいります｡</p>
<p>
	【最寄駅】<br />
	ＪＲ横浜駅<br />
	西口から徒歩５分</p>
...
<p>
	【開設ｸﾗｽ】<br />
	･<!--?php print setQueryString(''); ?--><!--?php print setQueryString('http://nichinare.com/m/course/index.php'); ?-->週１回ｸﾗｽ 基礎科（本科）<br />
	･<!--?php print setQueryString('http://nichinare.com/m/course/jr.php'); ?-->ｼﾞｭﾆｱ声優ｸﾗｽ</p>
</td>
</tr>
</table>
</div>
