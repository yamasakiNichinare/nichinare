			...
			<tr>
				<td style="text-align: left; font-size: x-small" valign="top">
					<p>
						...
						入所案内に同封されている<strong>当所所定の申込書</strong>に必要事項をご記入いただき､写真を貼付のうえ､お申し込みください｡追って､日時･場所などの詳細をお送りいたします｡<br />
			...
			<tr>
				<td style="text-align: left; font-size: x-small" valign="top">
					<p>
						...
						例年､多数のお申し込みをいただいており､ご案内までにお時間をいただくことも増え､お申し込みいただきました方々にご迷惑をお掛けすることも多くございましたため､今回このような決定に至りました｡つきましては､｢週１回（週３回）ｸﾗｽ｣の入所をお考えの皆様には､多くの方にご参加いただける『無料体験ﾚｯｽﾝ』をご利用のうえ､ご検討いただきますようお願い申し上げます｡<br />
						<br />
						<strong>■｢声優ｽﾀｰﾃｨﾝｸﾞｾﾐﾅｰ｣ﾚｯｽﾝ見学終了のお知らせ■</strong><br />
						誠に勝手ではございますが､これまで実施してまいりました｢声優ｽﾀｰﾃｨﾝｸﾞｾﾐﾅｰ｣の演技ﾚｯｽﾝの見学につきましては､平成２９年度をもちまして一旦終了とさせていただきました｡<br />
						<br />
						詳しくは､当所の入所案内をご参照ください｡<br />
						<a href="https://nichinare.com/m/request/form.cgi">&rArr;入所案内のお申し込みはこちら（無料）</a></p>
				</td>
			</tr>
		</tbody>
