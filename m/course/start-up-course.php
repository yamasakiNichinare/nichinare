		...
		<tbody>
			<tr>
				<td style="text-align: left; font-size: x-small" valign="top">
					...
					これまで当所でも､長年にわたり育成･指導をしていくなかで､このような演技ﾚｯｽﾝを通し､受講者が社会で必要とされているさまざまなｽｷﾙを身につけ､声優･俳優としてだけでなく､多くのｼｰﾝで活躍する様子を目にしてまいりました｡<br />
					...
					年齢や職業もさまざまなｸﾞﾙｰﾌﾟの 中で､日頃はあまり接点のない方々との出会いが､自然とｺﾐｭﾆｹｰｼｮﾝ能力を向上させ､また､視野を広げ､感性を刺激させるなど､人間成長につながっていくものと思われます｡<br />
					これらの経験を踏まえ､当所ではより多くの方々に｢演技ﾚｯｽﾝ｣の場を提供させていただくことで､演技の楽しさはもちろんのこと､数多くのｽｷﾙのなかから､自分に足りていないものを補う一助にしていただけると考えております｡</td>
			</tr>
		</tbody>
	</table>
</div>
