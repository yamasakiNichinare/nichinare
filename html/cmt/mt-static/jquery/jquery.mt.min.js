 ...
 *
 * $Id: jquery.mt.min.js 5356 2010-03-03 05:34:40Z auno $
 */
...
c);return this.each(function(){a(this).click(function(){a("form#"+b.id+" > input[name=__mode]").val("save_entries")})})};a.fn.mtDeleteItems=function(c){var b=a.extend({args:{}},c);return this.each(function(){a(this).click(function(){doRemoveItems(a("#"+b.id)[0],b.singular,b.plural,"",b.args);return false})})};a.fn.mtEnableUsers=function(c){var b=a.extend({args:{}},c);return this.each(function(){a(this).click(function(){setObjectStatus(a("#"+b.id)[0],b.plural,b.phrase,1,"",b.args);return false})})};
a.fn.mtDisableUsers=function(c){var b=a.extend({args:{}},c);return this.each(function(){a(this).click(function(){var d=a("#sysadmin")[0];if(d&&d.checked){alert(b.message);d.click();return false}setObjectStatus(a("#"+b.id)[0],b.plural,b.phrase,0,"",b.args);return false})})};a.fn.mtDoPluginAction=function(c){var b=a.extend({args:{}},c);return this.each(function(){a(this).click(function(){doPluginAction(a("#"+b.id)[0],b.plural,b.args,b.phrase);return false})})};a.fn.mtSetObjectStatus=function(c){var b=
a.extend({args:{}},c);return this.each(function(){a(this).click(function(){setObjectStatus(a("#"+b.id)[0],b.singular,b.plural,b.status,"",b.args);return false})})};a.fn.mtRebasename=function(c){var b=a.extend({text:"..."},c);return this.each(function(){var d=a("input#basename"),e=d.hide().val();d.hide().before('<span class="basename-text"></span>');d.parent("span.basename").after('<button id="mt-set-basename" class="mt-edit-field-button">'+b.edit+"</button>");b.basename?a("span.basename-text").text(b.basename):
a("span.basename-text").text(e||b.text);a(this).keyup(function(){if(!b.basename){e=dirify(a(this).val());if(b.limit)e=e.substring(0,b.limit);a("span.basename-text").text(e||b.text);d.val(e)}});a("button#mt-set-basename").click(function(){a(this).hide();a("span.basename-text").hide();a("input#basename").show();return false})})};a.fn.mtEditInput=function(c){var b=a.extend({save:"Save"},c);return this.each(function(){var d=a(this).attr("id"),e=a("input#"+d);if(e.val()&&!e.hasClass("show-input")){e.before('<span class="'+
d+'-text"></span>').after('<button id="mt-set-'+d+'" class="mt-edit-field-button">'+b.edit+"</button>").hide();a("span."+d+"-text").text(e.val())}!e.val()&&e.hasClass("hide-input")&&e.before('<span class="'+d+'-text"></span>').after('<button id="mt-set-'+d+'" class="mt-edit-field-button">'+b.edit+"</button>").hide();a("button#mt-set-"+d).click(function(){a(this).hide();a("span."+d+"-text").hide();a("input#"+d).show();a("p#"+d+"-warning").show();return false})})};a.fn.mtCheckboxOption=function(){return this.each(function(){var c=
a(this).find(":checkbox"),b=c.attr("id");c.attr("checked")||a("div#"+b+"-option").hide();c.click(function(){a("div#"+b+"-option").toggle()})})};a.fn.mtToggleNext=function(c){var b=a.extend({click_class:"detail-link",detail_class:"detail"},c);return this.each(function(){var d=a(this);a("."+b.detail_class).hide();d.find("."+b.click_class).click(function(e){d.toggleClass("active").find("."+b.detail_class).toggle();e.preventDefault()})})}})(jQuery);
