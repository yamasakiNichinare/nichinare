...
<!-- Smartphone cache -->
<div class="setting">
<div class="label"><label for="mtkk_smartphone_cache_size"><MT_TRANS phrase="Smartphone Cache Size">: </label></div>
<div class="field">
<input type="text" name="smartphone_cache_size" id="mtkk_smartphone_cache_size" value="<TMPL_VAR NAME=SMARTPHONE_CACHE_SIZE ESCAPE=HTML>" style="width: 4em;" />
<MT_TRANS phrase="kilobytes(0 means no limit)">
</div>
</div>
...
<div class="setting">
<div class="label"><label for="mtkk_smartphone_encoding"><MT_TRANS phrase="Smartphone character encoding">:</label></div>
<div class="field">
<input type="radio" name="smartphone_encoding" id="mtkk_smartphone_encoding_utf8" value="UTF-8"<TMPL_IF NAME=SMARTPHONE_ENCODING_UTF8> checked="checked"</TMPL_IF> />
<label for="mtkk_smartphone_encoding_utf8"><MT_TRANS phrase="UTF-8"></label>
<input type="radio" name="smartphone_encoding" id="mtkk_smartphone_encoding_sjis" value="Shift_JIS"<TMPL_IF NAME=SMARTPHONE_ENCODING_SJIS> checked="checked"</TMPL_IF> />
<label for="mtkk_smartphone_encoding_sjis"><MT_TRANS phrase="Shift JIS"></label>
</div>
</div>
...
<!-- Crawler keywords -->
<p><span style="color: red; font-weight: bold;">[<MT_TRANS phrase="Advanced Setting">]</span> <MT_TRANS phrase="Set comma separated keywords in user agent to consider if it is crawler. If keitai pages accessed by crawler, pagination will be disabled."></p>
<div class="setting">
<div class="label"><label for="mtkk_crawler_keywords"><MT_TRANS phrase="Crawler Keywords">:</label></div>
<div class="field">
<input type="text" name="crawler_keywords" id="mtkk_crawler_keywords" value="<TMPL_VAR NAME=CRAWLER_KEYWORDS ESCAPE=HTML>" style="width: 95%" />
</div>
</div>
