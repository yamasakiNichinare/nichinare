...
<td valign="top" style="font-size:x-small; text-align:left; color:#4ca778;"><strong>NEW ■１０月生 限定募集のお知らせ</strong></td>
</tr>
</table>
</div>
...
<div>
	※年間受講料のみ分割納付可能です｡</div>
<div>
	※弊所を一度退所し､令和元年度より再度入所される方につきましては､入所後の所定の手続きにより､再入所時の入所金の半額を返金（または受講料に充当）させていただきます｡</div>
<div>
