	...
	<table border="0" cellpadding="0" cellspacing="0" style="margin-top: 5px">
		<tbody>
			<tr>
				<td style="text-align: left; font-size: x-small" valign="top">
					<br />
					<span style="color: #98d1a9">■</span>対象年齢<br />
					中学3年生以上､40歳まで<br />
					<br />
					<span style="color: #98d1a9">■</span>参加条件<br />
					心身ともに健康な方<br />
					<br />
					<span style="color:#ff0000;"><strong>※2019年度10月入所をご検討の方で､無料体験ﾚｯｽﾝ参加をご希望の方は､7･8月の無料体験ﾚｯｽﾝをお申し込みください｡</strong></span><br />
					<br />
	...
	<table border="0" cellpadding="0" cellspacing="0" style="margin-top: 5px">
		<tbody>
			...
			<tr>
				<td style="text-align: left; font-size: x-small" valign="top">
					<p>
						<span style="font-size: 80%">&nbsp;&nbsp;締切：7月4日（木）</span></p>
				</td>
			</tr>
			<tr>
				<td style="text-align: left; font-size: x-small" valign="top">
	...
	<table border="0" cellpadding="0" cellspacing="0" style="margin-top: 5px">
		<tbody>
			...
			<tr>
				<td style="text-align: left; font-size: x-small" valign="top">
					<p>
						<span style="font-size: 80%">&nbsp;&nbsp;締切：7月10日（水）</span></p>
				</td>
			</tr>
			<tr>
				<td style="text-align: left; font-size: x-small" valign="top">
