...
<div style="background:#6cbd85; text-align:center;"><?php mtkk_image_tag(array('url' => '/m/group/img/group_tit.jpg', 'display' => 'browser', 'attr' => array('src' => '/m/group/img/group_tit.jpg'))); ?></div>
		...
		<tbody>
			<tr>
				<td style="text-align: left; font-size: x-small" valign="top">
					■株式会社ｱｰﾂﾋﾞｼﾞｮﾝ<br />
					声優･俳優･ﾅﾚｰﾀｰをﾏﾈｰｼﾞﾒﾝﾄ<br />
					<br />
					■株式会社ｱｲﾑｴﾝﾀｰﾌﾟﾗｲｽﾞ<br />
					声優･俳優･ﾅﾚｰﾀｰをﾏﾈｰｼﾞﾒﾝﾄ<br />
					<br />
					■株式会社ｳﾞｨﾑｽ<br />
					声優･俳優･ﾀﾚﾝﾄ･ﾅﾚｰﾀｰをﾏﾈｰｼﾞﾒﾝﾄ<br />
					<br />
					■株式会社ｸﾚｲｼﾞｰﾎﾞｯｸｽ<br />
					ﾅﾚｰﾀｰ･声優･俳優をﾏﾈｰｼﾞﾒﾝﾄ<br />
					<br />
					■株式会社ｱﾗｲｽﾞﾌﾟﾛｼﾞｪｸﾄ<br />
					声優･俳優･ﾅﾚｰﾀｰをﾏﾈｰｼﾞﾒﾝﾄ<br />
					<br />
					■有限会社澪ｸﾘｴｰｼｮﾝ<br />
					関西地区での活動をﾏﾈｰｼﾞﾒﾝﾄ</td>
			</tr>
		</tbody>
	</table>
</div>
