...
var mtCookieDomain = ".nichinare.com";
var mtCookiePath = "/";
...
_setCurrentComments();
  ...
  function _initializeVariables() {
    ...
    loadingIcon = "<img title='Loading...' src='https://nichinare.com/cmt/mt-static/images/indicator.white.gif' alt='Loading' />";
...
if (_findIdMatch(found[1])) {
  ...
  function _updateComments() {
    ...
    jsonUrl = [
        "https://nichinare.com/cmt/mt-comments.cgi?__mode=comment_listing&direction=",
        direction,
        "&entry_id=",
        entryID,
        "&limit=",
...
function mtFetchUser(cb) {
    ...
    if ( ( cb == 'mtSetUser' ) && mtGetUser() ) {
        ...
        script.src = 'https://nichinare.com/cmt/mt-comments.cgi?__mode=session_js&blog_id=10&jsonp=' + cb + '&ts=' + ts;
...
function mtCommentOnSubmit(f) {
    if (!mtRequestSubmitted) {
        ...
        if (f.armor)
            f.armor.value = '036711a4b410f4b5b517a54bee870c6655bbbb54';
...
function mtSignIn() {
    ...
    var url = 'https://nichinare.com/cmt/mt-cp.cgi?__mode=login&blog_id=10';
    if (is_preview) {
        if ( document['comments_form'] ) {
            var entry_id = document['comments_form'].entry_id.value;
            url += '&entry_id=' + entry_id;
        } else {
            url += '&return_url=https%3A%2F%2Fnichinare.com%2Fm%2Ftest%2F';
        }
    } else {
...
function mtSignOut(entry_id) {
    ...
    var doc_url = document.URL;
    doc_url = doc_url.replace(/#.+/, '');
    var url = 'https://nichinare.com/cmt/mt-cp.cgi?__mode=logout&static=0';
    if (is_preview) {
        if ( document['comments_form'] ) {
            var entry_id = document['comments_form'].entry_id.value;
            url += '&entry_id=' + entry_id;
...
function mtShowGreeting() {
    ...
    if ( u && u.is_authenticated ) {
        if ( u.is_banned ) {
            ...
            var user_link;
            if ( u.is_author ) {
                user_link = '<a href="https://nichinare.com/cmt/mt-comments.cgi?__mode=edit_profile&return_url=' + encodeURIComponent( location.href );
                user_link += '">' + u.name + '</a>';
            } else {
